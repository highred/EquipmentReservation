                        ...
                        <tr key={company.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div className="flex items-center justify-end space-x-3">
                                    <button onClick={() => onEdit(company)} className="p-2 text-gray-500 dark:text-gray-400 hover:text-brand-primary transition-colors" aria-label="Edit Company">
                                        <PencilIcon className="w-5 h-5" />
                                    </button>
                                    <button onClick={() => onDelete(company)} className="p-2 text-gray-500 dark:text-gray-400 hover:text-status-danger transition-colors" aria-label="Delete Company">
