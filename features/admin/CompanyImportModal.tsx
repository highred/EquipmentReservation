        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 w-full max-w-2xl m-4">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Import & Update Companies from CSV</h2>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-md">
                            <li>If a company <code className="text-xs bg-gray-200 dark:bg-gray-600 dark:text-gray-200 p-1 rounded">name</code> already exists, it will be skipped (counted as 'updated').</li>
                            <li>If a <code className="text-xs bg-gray-200 dark:bg-gray-600 dark:text-gray-200 p-1 rounded">name</code> does not exist, a new company will be created.</li>
                            <li>Your CSV file must contain the header: <code className="text-xs bg-gray-200 dark:bg-gray-600 dark:text-gray-200 p-1 rounded">name</code></li>
                            <li>
                                ...
                                <div className="mt-2 border-t dark:border-gray-600 pt-2 max-h-40 overflow-y-auto">
                                    ...
                                    <ul className="list-disc list-inside text-xs text-red-600 dark:text-red-400 space-y-1">
                                        {importResult.errors.map((err, index) => (
                                            <li key={index}>Row for <code className="bg-red-100 dark:bg-red-900/40 p-0.5 rounded">{err.rowData?.name || 'N/A'}</code>: {err.message}</li>
                                        ))}
                                    </ul>
                                </div>
                            )}
