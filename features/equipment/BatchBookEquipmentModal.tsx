        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 w-full max-w-lg m-4">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Batch Book Equipment</h2>
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-md mb-6">
                    <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Selected Equipment ({selectedEquipment.length})</h4>
                    <div className="max-h-32 overflow-y-auto space-y-1 text-xs">
                        {selectedEquipment.map(eq => (
                            <div key={eq.id} className="text-gray-800 dark:text-gray-200 font-medium">
                                {eq.description} <span className="text-gray-500 dark:text-gray-400">({eq.gageId})</span>
                            </div>
                        ))}
                    </div>
                </div>
