...
import { CalendarIcon, CogIcon, UserIcon, WrenchScrewdriverIcon, LogoutIcon, BuildingOfficeIcon, MoonIcon, SunIcon, ClipboardDocumentListIcon } from './icons/Icons';
...
const ICONS: Record<Tab, React.ReactNode> = {
    ...
    STAGING: <ClipboardDocumentListIcon className="w-5 h-5 mr-2" />,
